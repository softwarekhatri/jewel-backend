...
// All image IDs verified 200 OK as of reseed
const img = (id: string) => `https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=800&q=80`;

const I = {
  goldNecklace:    img('1611652022419-a9419f74343d'),
  goldJewelry:     img('1599643478518-a784e5dc4c8f'),
  diamondRing:     img('1605100804763-247f67b3557e'),
  ring:            img('1603561591411-07134e71a2a9'),
  ringGold:        img('1617038220319-276d3cfab638'),
  earrings:        img('1535632066927-ab7c9ab60908'),
  earringsSilver:  img('1588444837495-c6cfeb53f32d'),
  earringsHoop:    img('1576566588028-4147f3842f27'),
  bangles:         img('1515562141207-7a88fb7ce338'),
  jewellerySet:    img('1559056199-641a0ac8b55e'),
  necklace:        img('1602173574767-37ac01994b2a'),
  silverNecklace:  img('1506630448388-4e683c67ddb0'),
  anklet:          img('1619119069152-a2b331eb392a'),
  templeJewel:     img('1617038260897-41a1f14a8ca0'),
  pendantSet:      img('1561828995-aa79a2db86dd'),
  crystalEarring:  img('1611591437281-460bfbe1220a'),
};
...
const products = [
  // ─── GOLD ────────────────────────────────────────────────────────────────────
  {
    ...
    category: 'gold',
    subcategory: 'set',
    images: [I.goldNecklace, I.goldJewelry],
    stock: 5,
    weight: '42g',
  ...
  },
  {
    ...
    images: [I.earrings, I.earringsSilver],
    stock: 12,
    weight: '8.6g',
    material: '22K Gold',
  ...
  },
  {
    ...
    category: 'gold',
    subcategory: 'bangles',
    images: [I.bangles, I.jewellerySet],
    stock: 6,
    weight: '32g (set of 4)',
    material: '22K Gold',
  ...
  },
  {
    ...
    images: [I.necklace, I.goldNecklace],
    stock: 10,
    weight: '12g',
  ...
  },
  {
    ...
    category: 'gold',
    subcategory: 'necklace',
    images: [I.templeJewel, I.goldJewelry],
    stock: 3,
    weight: '55g',
    material: '22K Gold',
  ...
  // ─── SILVER ──────────────────────────────────────────────────────────────────
  {
    ...
    category: 'silver',
    subcategory: 'necklace',
    images: [I.silverNecklace, I.necklace],
    stock: 20,
    weight: '28g',
  ...
  },
  {
    ...
    category: 'silver',
    subcategory: 'earrings',
    images: [I.earringsHoop, I.earringsSilver],
    stock: 18,
    weight: '6g',
  ...
  },
  {
    ...
    category: 'silver',
    subcategory: 'necklace',
    images: [I.silverNecklace, I.pendantSet],
    stock: 14,
    weight: '18g',
    material: '925 Sterling Silver',
  ...
  },
  {
    ...
    category: 'artificial',
    subcategory: 'earrings',
    images: [I.earrings, I.earringsHoop],
    stock: 50,
    weight: '8g',
  ...
  },
  {
    ...
    category: 'artificial',
    subcategory: 'necklace',
    images: [I.templeJewel, I.silverNecklace],
    stock: 30,
    weight: '45g',
  ...
  },
  {
    ...
    category: 'artificial',
    subcategory: 'earrings',
    images: [I.crystalEarring, I.earringsHoop],
    stock: 45,
    weight: '15g',
  ...
  },
  {
    ...
    category: 'artificial',
    subcategory: 'pendant',
    images: [I.crystalEarring, I.goldJewelry],
    stock: 20,
    weight: '35g (set)',
  ...
  },
  {
    ...
    category: 'artificial',
    subcategory: 'necklace',
    images: [I.jewellerySet, I.silverNecklace],
    stock: 55,
    weight: '18g',
...
const reseedDatabase = async (): Promise<void> => {
  ...
  try {
    ...
    console.log(`Inserting ${products.length} products with verified images...`);
    const inserted = await Product.insertMany(products);
    console.log(`Inserted ${inserted.length} products.\n`);

    const gold = inserted.filter((p) => p.category === 'gold').length;
    const silver = inserted.filter((p) => p.category === 'silver').length;
    const artificial = inserted.filter((p) => p.category === 'artificial').length;
